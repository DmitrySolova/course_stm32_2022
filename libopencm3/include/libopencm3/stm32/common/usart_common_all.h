...
#define USART_CR2_STOPBITS_1		(0x00U << 12U)     /* 1 stop bit */
#define USART_CR2_STOPBITS_0_5		(0x01U << 12U)     /* 0.5 stop bits */
#define USART_CR2_STOPBITS_2		(0x02U << 12U)     /* 2 stop bits */
#define USART_CR2_STOPBITS_1_5		(0x03U << 12U)     /* 1.5 stop bits */
#define USART_CR2_STOPBITS_MASK		(0x03U << 12U)
#define USART_CR2_STOPBITS_SHIFT	12U
