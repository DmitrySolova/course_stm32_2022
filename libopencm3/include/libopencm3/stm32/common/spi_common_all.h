...
@{*/
#define SPI_CR1_BAUDRATE_FPCLK_DIV_2	(0x00U << 3U)
#define SPI_CR1_BAUDRATE_FPCLK_DIV_4	(0x01U << 3U)
#define SPI_CR1_BAUDRATE_FPCLK_DIV_8	(0x02U << 3U)
#define SPI_CR1_BAUDRATE_FPCLK_DIV_16	(0x03U << 3U)
#define SPI_CR1_BAUDRATE_FPCLK_DIV_32	(0x04U << 3U)
#define SPI_CR1_BAUDRATE_FPCLK_DIV_64	(0x05U << 3U)
#define SPI_CR1_BAUDRATE_FPCLK_DIV_128	(0x06U << 3U)
#define SPI_CR1_BAUDRATE_FPCLK_DIV_256	(0x07U << 3U)
/**@}*/
/****************************************************************************/
...
@{*/
#define SPI_CR1_CPOL_CLK_TO_0_WHEN_IDLE	(0U << 1U)
#define SPI_CR1_CPOL_CLK_TO_1_WHEN_IDLE	(1U << 1U)
/**@}*/
...
@{*/
#define SPI_CR1_CPHA_CLK_TRANSITION_1	(0U << 0U)
#define SPI_CR1_CPHA_CLK_TRANSITION_2	(1U << 0U)
/**@}*/
